...
const Installation = ({ allAppsPromise }) => {
    ...
    return (
        <div className="text-center pt-20 pb-10">
            ...
            {
                installedApps.length !== 0 ? <div className="flex flex-col  md:flex-row gap-3 md:justify-between py-5 px-10 text-[#001931] font-semibold text-[20px]">
                    ...
                    : <h1 className='text-2xl font-bold flex justify-center items-center bg-linear-to-br from-[#e32e2e] to-[#9F62F2] bg-clip-text text-transparent my-10 mx-auto text-center whitespace-nowrap'>No Installed Apps F<img className='w-5 animate-spin' src={logo} />und.
                    </h1>
            }
            {
